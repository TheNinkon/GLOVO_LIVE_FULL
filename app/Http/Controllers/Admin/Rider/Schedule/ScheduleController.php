...
namespace App\Http\Controllers\Rider\Schedule;
...
class ScheduleController extends Controller
{
    ...
    public function index($week = null): View
    {
        ...
        if ($forecast) {
            $preparedScheduleData = $this->prepareScheduleDataForView($forecast, $rider->id);
            $scheduleData = $preparedScheduleData['days'];
            $myHoursCount = $preparedScheduleData['mySchedules']->count() * 0.5;
    ...
    /**
     * Devuelve los datos del forecast y los horarios del rider en formato JSON.
     * Este método será llamado por AJAX para cargar el calendario.
     */
